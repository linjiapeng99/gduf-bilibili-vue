...
export default {
    ...
    methods: {
        ...
        async uploadFileBySlices(selectedFile){
            ...
            const totalSliceNo = Math.ceil(selectedFile.size / sliceSize);//总分片数量
            const uploadSlice = (sliceIndex) =>{
                const start = sliceIndex * sliceSize;//起始上传位置
                ...
                return new Promise((resolve)=>{
                    ...
                    const formData = new FormData();//后端接受数据是form-data，因此需要构建好数据
