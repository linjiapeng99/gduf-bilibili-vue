...
export default {
  ...
  data(){
    return{
      items:[
        {
          imageUrl:require('@/assets/header/header-banner.png'),
          id:1
        },
        {
          imageUrl:require('@/assets/header/header-banner.png'),
      ...
      <div class="right-channel">
        <div class="right-channel-left">
          <a class="right-channel-left-link" v-for="(channel,index) in leftChannels"
             :key="index" :href="channel.href" target="_blank">{{channel.name}}</a>
        </div>
        <div class="right-channel-right">
          <a class="right-chnanel-right-link" v-for="(channel,index) in rightChannels"
             :key="index" :href="channel.href" target="_blank">{{channel.name}}</a>
        </div>
      </div>
    </div>
...
<!--      <el-menu-item v-for="menu in menus" :index="menu.index" :key="menu.index" @click="$router.push(menu.path)">{{menu.name}}</el-menu-item>-->
<!--    </el-menu>-->
